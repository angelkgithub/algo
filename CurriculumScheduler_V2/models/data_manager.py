...
class DataManager:
    ...
    def _validate_faculty_data(self):
        ...
        required_columns = [
            'faculty_name', 'employment_type', 'max_hours_per_week', 'available_days', 'specialization'
        ]
    ...
    def load_default_faculty(self):
        ...
        faculty_data = [
            {"faculty_name": "Prof. John Smith", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday", "specialization": "Computer Science"},
            {"faculty_name": "Prof. Maria Garcia", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday", "specialization": "Information Systems"},
            {"faculty_name": "Prof. Robert Johnson", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday", "specialization": "Information Technology"},
            {"faculty_name": "Prof. Lisa Brown", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday,Saturday", "specialization": "Programming"},
            {"faculty_name": "Prof. David Wilson", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday", "specialization": "Database Systems"},
            {"faculty_name": "Prof. Sarah Davis", "employment_type": "Part-time", "max_hours_per_week": 18, "available_days": "Tuesday,Thursday,Saturday", "specialization": "Web Development"},
            {"faculty_name": "Prof. Michael Miller", "employment_type": "Part-time", "max_hours_per_week": 18, "available_days": "Monday,Wednesday,Friday", "specialization": "Network Security"},
            {"faculty_name": "Prof. Jennifer Taylor", "employment_type": "Part-time", "max_hours_per_week": 18, "available_days": "Tuesday,Thursday,Saturday", "specialization": "Software Engineering"},
            {"faculty_name": "Prof. Christopher Anderson", "employment_type": "Full-time", "max_hours_per_week": 30, "available_days": "Monday,Tuesday,Wednesday,Thursday,Friday", "specialization": "Algorithms"},
            {"faculty_name": "Prof. Amanda White", "employment_type": "Part-time", "max_hours_per_week": 18, "available_days": "Monday,Wednesday,Friday,Saturday", "specialization": "General Education"},
        ]
